...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border-2 border-gray-200 dark:border-gray-800 bg-white dark:bg-black text-black dark:text-white shadow-lg hover:shadow-xl transition-all duration-300",
      className
    )}
    {...props}
  />
